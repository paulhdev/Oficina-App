...
1. Instale algum emulador Android como Genymotion, use o emulador do próprio Android Studio _ou então uma opção um pouco mais fácil:_ instale o _adb devices_, ative a depuração USB no modo desenvolvedor do seu despositivo móvel e plugue no seu computador ou notebook
